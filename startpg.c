...
int loadembeddedstartpage(char *buffer, long buffer_max, char *token) {
  int x = 0, y, z;
  char *clist[16] = {NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL};
  char *wel0 = "i\ni          ***  Gopherus v" pVer " Copyright (C) " pDate " Mateusz Viste  ***\n";
  char *wel1 = "i                                           .---.           _....._\n"
               "i Welcome to Gopherus, a multiplatform,    /  p  `\\     .-\"\"`:     :`\"-.\n"
               "i console-mode gopher client.              |__   - |  ,'     .     '    ',\n"
               "i                                           ._>    \\ /:      :     ;      :,\n"
               "i You'll find below a few gopher links that  '-.    '\\`.     .     :     '  \\\n";
  char *wel2 = "i might help you start your journey in the      `.   | .'._.' '._.' '._.'.  |\n"
  ...
  char *lic0 = "\n Gopherus v" pVer " Copyright (C) " pDate " Mateusz Viste\n";
  char *lic1 = "\n"
               ...
               " version.\n"
                     "\n";
  char *lic2 = " This program is distributed in the hope that it will be useful, but WITHOUT\n"
  ...
  char *man2 = "   BACKSPC   - Go back to the previous location\n"
  ...
  char *man3 = " variable have to contain exacty 6 color attributes. Each attribute is\n"
  ...
  char *man5 = "                | | | | | | +----- Error item in menu\n"
               ...
               "                |\n";
  char *man6 = "                +----------------- Normal text (text files or menu 'i' items)\n"
               "\n"
               " Example:\n"
  ...
  for (z = 0; clist[z] != NULL; z++) {
    for (y = 0; clist[z][y] != 0; ) {
      buffer[x++] = clist[z][y++];
      if (x >= buffer_max) return(x);
    }
  }
  return(x);
}
